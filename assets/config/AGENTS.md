...
- Preferred launch: `start-grok` (auto proxy + rtk ensure; `grok-4.7` goes through Headroom). Vanilla: `-m grok-4.7-direct`. `grok-4.6` still Headroom.
...
- Coding: `grok-mcp-coding` or `start-grok -McpProfile coding` (Serena + Headroom only).
- Personal mail/calendar: `grok-mcp-personal`.
- Do **not** paste full `~/.grok/rules/*` into TUI user rules — use `user-rules-thin.md`.
